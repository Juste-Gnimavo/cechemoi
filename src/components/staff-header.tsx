      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between py-3 border-b border-gray-200 dark:border-dark-800">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Staff Badge */}
            <div className="hidden md:flex items-center space-x-2 bg-green-500/20 px-3 py-1.5 rounded-full border border-green-500/30">
              <Briefcase className="h-4 w-4 text-green-400" />
              <span className="text-sm font-medium text-green-400">Staff</span>
            </div>
        ...
        {/* Desktop Navigation */}
        <nav className="hidden md:block py-2 bg-gray-50 dark:bg-transparent -mx-4 px-4">
