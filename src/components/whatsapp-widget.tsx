...
export function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9998] flex flex-col items-end gap-3">
      {/* Tooltip */}
      <div
        className={`bg-white text-gray-800 px-4 py-2 rounded-lg shadow-lg transition-all duration-300 ${
          isHovered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none'
        }`}
      >
        <p className="text-sm font-medium whitespace-nowrap">Besoin d'aide ? Chattez avec nous !</p>
