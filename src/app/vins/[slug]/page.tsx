...
/**
 * Wine category page - alias for /categorie-vin/[slug]
 * URL format: /vins/vin-rouge, /vins/vin-blanc, etc.
 */
export default function VinsCategoryPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-dark-950">
      ...
      <main className="flex-1">
        {/* Category Header */}
        <div className="border-b border-gray-200 dark:border-dark-700 bg-gradient-to-b from-gray-100 dark:from-dark-800 to-transparent">
          <div className="container mx-auto px-4 py-12">
            <div className="flex items-center gap-3 mb-4">
              <Wine className="w-8 h-8 text-primary-500" />
              <h1 className="text-4xl font-sans font-bold text-gray-900 dark:text-white">
                {category.name}
              </h1>
            </div>
