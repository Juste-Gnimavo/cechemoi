    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Nouveau tag</h1>
            <p className="text-gray-500 dark:text-gray-400 mt-1">Créer un nouveau tag pour le blog</p>
          </div>
        </div>
      </div>
