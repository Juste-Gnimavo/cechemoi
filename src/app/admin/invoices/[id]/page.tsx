        ...
        <div className="flex items-center justify-between bg-white/50 dark:bg-dark-900/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-dark-700/50 p-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 bg-purple-500/10 hover:bg-purple-500/20 text-purple-400 border border-purple-500/30 rounded-lg transition-all duration-200 text-sm"
            >
            ...
            <button
              ...
              disabled={deleting}
              className="flex items-center gap-2 px-3 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-500 border border-red-500/30 rounded-lg transition-all duration-200 text-sm"
            >
                ...
                <div className="flex flex-wrap gap-2">
                  {invoice.status !== 'PAID' && (
                    <button
                      ...
                      disabled={updating}
                      className="flex items-center gap-1 px-3 py-1.5 bg-green-500 hover:bg-green-600 text-white font-medium rounded-lg text-sm transition-all shadow-sm"
                    >
