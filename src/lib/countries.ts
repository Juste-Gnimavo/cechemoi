...
// Full list of world countries / territories.
// African countries are listed first (primary market), then the rest of the world
// in alphabetical order by French name.
export const countries: Country[] = [
  // ===== Africa (primary market — listed first) =====
  ...
  // ===== Rest of the world (alphabetical by French name) =====
  ...
  { code: 'GS', name: 'Géorgie du Sud-et-les Îles Sandwich du Sud', dialCode: '+500', flag: '🇬🇸' },
  ...
  { code: 'TC', name: 'Îles Turks-et-Caïques', dialCode: '+1649', flag: '🇹🇨' },
  ...
  { code: 'MM', name: 'Myanmar (Birmanie)', dialCode: '+95', flag: '🇲🇲' },
  ...
  { code: 'PN', name: 'Îles Pitcairn', dialCode: '+64', flag: '🇵🇳' },
